...
#'
#' @return \code{forms_spreadsheet}: a data frame containing user-provided MS Forms data plus one column that \code{xmlGenerator::load_data()} left-joins to \code{forms_spreadsheet}: \code{forms_spreadsheet$value} that contains EndNote reference-type values for \code{xmlGenerator::build_xml()}.
